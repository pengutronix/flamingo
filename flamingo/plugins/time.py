...
class HTML5TimeTag:
    ...
    def _comp(self, other, comp):
        ...
        if not isinstance(self_time_object, datetime.datetime):
            self_time_object = datetime.datetime.combine(self_time_object, datetime.datetime.min.time())
        ...
        if not isinstance(other_time_object, datetime.datetime):
            other_time_object = datetime.datetime.combine(other_time_object, datetime.datetime.min.time())
