...
class WarningStream:
    ...
    def write(self, warning):
        ...
        offset = self.context.content.get("content_offset", 0) + plugin.offsets.get(path, 0)
...
def parse_rst_parts(rst_input, context, system_message_re=SYSTEM_MESSAGE_RE, doctitle_xform=False):
    # setup offset
