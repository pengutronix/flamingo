...
def test_I18N_link(flamingo_env):
    ...
    flamingo_env.write('/content/index_de.html', """
    id: index
    lang: de
    ...
    flamingo_env.write('/content/index_en.html', """
    id: index
    lang: en
    ...
    assert flamingo_env.read('/output/de/page.html').endswith(
        '/index_de.html')

    assert flamingo_env.read('/output/de/page2.html').endswith(
        '/index_en.html')
